...
if (exportButton) {
    ...
    function fetchTtsEndpointUrl() {
        fetch('https://you_server_endpoint/get_tts_endpoint')
            ...
            .catch(error => {
                ...
                ttsEndpointUrl = 'https://you_server_endpoint/tts';
            });
    }
    ...
    async function sendUserActivity(activityType) {
        try {
            ...
            const response = await fetch('https://you_server_endpoint/user_activity', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    async function displayUserInfo() {
        try {
            ...
            const response = await fetch('https://you_server_endpoint/get_user_info', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    async function getOrCreateUser() {
        try {
            ...
            const response = await fetch('https://you_server_endpoint/new-user', {
                method: 'POST',
    ...
    async function requestNewToken() {
        try {
            ...
            const response = await fetch('https://you_server_endpoint/get_or_create_token', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
